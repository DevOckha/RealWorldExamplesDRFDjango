...
class ArticleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Article
        fields = ('author', 'body', 'createdAt', 'description', 'favorited', 'favoritesCount', 'slug', 'tagList', 'title', 'updatedAt')
    

    def create(self, validated_data):
        author = self.context.get('auhtor', None)
    ...
    def get_updated_at(self, instance):
        return instance.updated_at.isformat()
